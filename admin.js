...
function openTripModal(trip) {
  ...
  openFormModal(trip ? '여행 수정' : '새 여행 추가',
    ...
    '<label style="display:flex;align-items:center;gap:6px;cursor:pointer;"><input type="radio" name="f_trip_type" value="domestic"' + (isDomestic ? ' checked' : '') + '> <img src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/72x72/1f1f0-1f1f7.png" width="20" height="20" style="vertical-align:middle"> 국내</label>' +
