...
function openTripModal(trip) {
  ...
  openFormModal(trip ? '여행 수정' : '새 여행 추가',
    ...
    '<label style="display:flex;align-items:center;gap:6px;cursor:pointer;"><input type="radio" name="f_trip_type" value="domestic"' + (isDomestic ? ' checked' : '') + '> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 40" width="30" height="20" style="vertical-align:middle;border-radius:2px;border:1px solid #ccc"><rect width="60" height="40" fill="white"/><path d="M20,20 A10,10,0,0,0,40,20 A5,5,0,0,0,30,20 A5,5,0,0,1,20,20Z" fill="#C60C30"/><path d="M20,20 A5,5,0,0,0,30,20 A5,5,0,0,1,40,20 A10,10,0,0,1,20,20Z" fill="#003478"/><g transform="translate(10,8) rotate(-45)"><rect x="-7" y="-3.5" width="14" height="2" fill="#000"/><rect x="-7" y="-.5" width="14" height="2" fill="#000"/><rect x="-7" y="2.5" width="14" height="2" fill="#000"/></g><g transform="translate(50,8) rotate(45)"><rect x="-7" y="-3.5" width="14" height="2" fill="#000"/><rect x="-7" y="-.5" width="5.5" height="2" fill="#000"/><rect x="1.5" y="-.5" width="5.5" height="2" fill="#000"/><rect x="-7" y="2.5" width="14" height="2" fill="#000"/></g><g transform="translate(10,32) rotate(45)"><rect x="-7" y="-3.5" width="5.5" height="2" fill="#000"/><rect x="1.5" y="-3.5" width="5.5" height="2" fill="#000"/><rect x="-7" y="-.5" width="14" height="2" fill="#000"/><rect x="-7" y="2.5" width="5.5" height="2" fill="#000"/><rect x="1.5" y="2.5" width="5.5" height="2" fill="#000"/></g><g transform="translate(50,32) rotate(-45)"><rect x="-7" y="-3.5" width="5.5" height="2" fill="#000"/><rect x="1.5" y="-3.5" width="5.5" height="2" fill="#000"/><rect x="-7" y="-.5" width="5.5" height="2" fill="#000"/><rect x="1.5" y="-.5" width="5.5" height="2" fill="#000"/><rect x="-7" y="2.5" width="5.5" height="2" fill="#000"/><rect x="1.5" y="2.5" width="5.5" height="2" fill="#000"/></g></svg> 국내</label>' +
